...
exports.default = {
  ...
  methods: {
    ...
    loadImages: function loadImages() {
      ...
      var loadBlazy = function loadBlazy(callback) {
        blazy = new Blazy('');
        callback();
      };
...
exports.default = {
  ...
  computed: {
    ...
    isNeighborhoodCountShow: function isNeighborhoodCountShow() {
      if (_store2.default.state.isItemOver) {
        return false;
      } else {
        return true;
      }
    ...
    isInfoGroupShow: function isInfoGroupShow() {
      if (_store2.default.state.isItemOver) {
        return true;
      } else {
        return false;
    ...
    isAddressShow: function isAddressShow() {
      if (_store2.default.state.isItemOver) {
        return true;
      } else {
        return false;
